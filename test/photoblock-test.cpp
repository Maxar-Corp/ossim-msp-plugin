...
//
//**************************************************************************************************
#include "atp/AtpConfig.h>
#include <iostream>
#include "atp/correlation/CorrelationAtpGenerator.h>
#include <TiePoint.h>
...
int main(int argc, char** argv)
{
   ...
   ossimMsp::AtpConfig* atpConfig = ossimMsp::AtpConfig::instance();
